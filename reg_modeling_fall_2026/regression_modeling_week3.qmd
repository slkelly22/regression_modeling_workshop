---
title: "Regression Modeling in R: Week 3"
...
Does a woman's college attendance relate to the probability of her working?
...
Does a woman's husband's college attendance relate to the probability of her working?

```{r}
#| echo: TRUE
#| eval: FALSE
activity_prob <- estimate_means(lg_model, by = "?", type = "response")
activity_prob
```
...
```{r}
activity_prob <- estimate_means(lg_model, by = "hc", type = "response")
activity_prob
```
...
-   Regression with Significiant Interactions

-   Simple Slopes Analysis and Visualization
