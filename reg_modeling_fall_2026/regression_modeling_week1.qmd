---
title: "Regression Modeling in R: Week 1"
author: "S.Kelly"
format: 
  revealjs: 
    theme: serif
    code-overflow: wrap
    footer: "S.Kelly | Regression Modeling in R | Fall 2026"
editor: visual
execute: 
  echo: true
---
...
Before we get started, let's get everything ready: <br>

- Set up an R Project

- Create a data folder with the `dir.create()` function

- Remember to comment your code `#`

- I'm working from a Quarto .qmd file, you will have a standard .R syntax file

## Why Statistics in R?

It's free, and you can track and reproduce every single step!

![SPSS](images/SPSS.png){width="600"}

## Why are trying to do in 4 weeks?

- Have a basic understanding of running regressions in R

- Troubleshooting commons issues, i.e., What's wrong with this picture?

- Understanding model diagnostics

- Confidently interpreting coefficients
